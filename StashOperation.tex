...
harga dan perhitungan laba pada kode program saya. saya menulis kode program berikut ini:\vspace{14pt}


Map pembelian = [10: 10000, 20: 10100, 30: 10200, 40: 11000]\par
Map penjualan = [5: 12000, 6: 13000, 3: 11000, 2: 11000, 1: 15000, 3: 12000]\par
...
\textbf{Membatalkan Apapun}\vspace{14pt}
...
lengkap dari pekerjaan mereka.\vspace{14pt}

Di bawah ini adalah fungsi dari VCS a:

\begin{itemize}
\item Memungkinkan pengembang untuk bekerja secara bersamaan.
\item Tidak memungkinkan Timpa perubahan masing-masing.
\item Mempertahankan sejarah setiap versi.
\end{itemize}
