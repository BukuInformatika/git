...
%%%%%%%%%%%%%%%%%%Isi Buku_
\chapter{Belajar Git}
\input{chapter/Akun_Github}

\chapter{Praktek Cepat}
\input{chapter/Home}

\chapter{Perintah Dasar Bash}
\input{chapter/Bash}

\chapter{Mengatasi Konfik}
\input{chapter/Konflik}

\chapter {Cara Membaca Pull Request}
\input{chapter/Pull_Request}

\chapter {Membuat Project Pada Gitlab}
\input{chapter/Project}

%\chapter{Environtment Setup}
%\input{chapter/Environment_Setup}

%\chapter{Life Cycle}
%\input{chapter/Life_Cycle}

%\chapter{Create Operation}
%\input{chapter/CreateOpration}

%\chapter{Clone Operation}
%\input{chapter/CloneOpration}

%\chapter{Perform Changes}
%\input{chapter/PerformChanges}

%\chapter{Review Changes}
%\input{chapter/ReviewChanges}

%\chapter{Commit Cahnges}
%\input{chapter/Commit_Changes}

%\chapter{Push Operation}
%\input{chapter/Push_Operation}

%\chapter{Update Operation}
%\input{chapter/UpdateOperation}

%\chapter{Stash Operation}
%\input{chapter/StashOperation}

%\chapter{Move Operation}
%\input{chapter/MoveOperation}

%\chapter{Rename Operation}
%\input{chapter/RenameOperation}
